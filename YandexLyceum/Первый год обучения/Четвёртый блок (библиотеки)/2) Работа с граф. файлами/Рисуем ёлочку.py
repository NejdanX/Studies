...
def picture(file_name, width, height, sky_color='#75BBFD',
    ...
    drawer.ellipse([(int(width * 0.8), -int(0.2 * height)),
                    (int(width * 1.2), int(height * 0.2))], sun_color)

    drawer.rectangle([int(width * 0.45), int(height * 0.7),
                      int(width * 0.55), int(height * 0.9)], trunk_color)

    drawer.polygon([int(width * 0.4), int(height * 0.3),
                    int(width * 0.5), int(height * 0.1),
                    int(width * 0.6), int(height * 0.3)], needls_color)
